...
<div class="mb-3">
 ...
 <div class="mb-3">
  ...
  <input name="dog" value="1" class="form-check-input" type="checkbox" id="input_check">
  <input name="dog" value="0" class="form-check-input" type="hidden" id="input_check_hidden">
  <label class="form-check-label" for="flexRadioDefault1">
    개
  </label>
  
    <input name="cat" value="1" class="form-check-input" type="checkbox" id="input_check">
  <input name="cat" value="0" class="form-check-input" type="hidden" id="input_check_hidden">
  <label class="form-check-label" for="flexRadioDefault1">
    고양이
  </label>
  
    <input name="bird" value="1" class="form-check-input" type="checkbox" id="input_check">
      <input name="bird" value="0" class="form-check-input" type="hidden" id="input_check_hidden">
  <label class="form-check-label" for="flexRadioDefault1">
  새
  </label>
  
  <input name="etc" value="1" class="form-check-input" type="checkbox"id="input_check">
    <input name="etc" value="0" class="form-check-input" type="hidden" id="input_check_hidden">
  <label class="form-check-label" for="flexRadioDefault1">
    기타
  </label>
</div>
