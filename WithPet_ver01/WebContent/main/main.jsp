            ...
            <header id="header" class="container">
              ...
              <nav id="nav">
               <ul>
                 ...
                 <li>
                  <a href="../hotel/hotel.jsp">호텔 찾기</a>
                  <ul>
                    <li><a href="../hotel/hotellocation.jsp">지도별 검색</a></li>
                    <li><a href="../hotel/hoteltype.jsp">종별 검색</a></li>
                  </li>
                  </ul>
                 </li>
                 ...
                 <li><a href="../community/community.jsp">커뮤니티</a>
                  <ul>
                     <li><a href="../community/community_encyclopedia.jsp">보호자 대백과</a></li>
                    </li>
                    </ul>
                  </li>
                  <li>
                     ...
                     <ul>
                        ...
                        <li><a href="../petsitter/petsitterform.jsp">펫시터 등록 신청</a>
                       </li>
                       </ul>
                     </li>
                     <li>
