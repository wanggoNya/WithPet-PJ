...
public class HotelDAO {
   ...
   public ArrayList<HotelDTO> getHotelList() throws NamingException, SQLException {
      ...
      try {
         String sql = "SELECT id, name, content, address, zipcode, cover, price, discountPrice, "
               + "dog, cat, bird, etc, phoneNumber, state, userId, status "
               + " FROM Hotel ";
   ...
   public int insertHotel(String name, String content, String address, String zipcode, 
         String cover, String price, String discount, String dog, String cat, String bird, String etc,
      ...
      try {
         ...
         pstmt.setInt(8, Integer.parseInt(dog));
         pstmt.setInt(9, Integer.parseInt(cat));
         pstmt.setInt(10, Integer.parseInt(bird));
         pstmt.setInt(11, Integer.parseInt(etc));
         pstmt.setString(12, phoneNumber);
         pstmt.setString(13, state);
         pstmt.setInt(14, Integer.parseInt(userId));
   ...
   public int updateHotel(String id, String name,String content, String address, String zipcode, 
      ...
      try {
         ...
         pstmt.setInt(7, Integer.parseInt(dog));
         pstmt.setInt(8, Integer.parseInt(cat));
         pstmt.setInt(9, Integer.parseInt(bird));
         pstmt.setInt(10, Integer.parseInt(etc));
         pstmt.setString(11, phoneNumber);
         pstmt.setString(12, state);
         pstmt.setInt(13, Integer.parseInt(userId));
         pstmt.setInt(14, Integer.parseInt(id));
   ...
   public int deleteHotel(String id) throws NamingException, SQLException {
      Connection conn = null;
      PreparedStatement pstmt = null;
      try {
