  ...
  %>                             
    <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold"><%=each.getNsj() %></h1>
        <p class="col-md-8 fs-4"><%=each.getNct() %></p>
        <a href="<%=each.getNlk() %>"><button class="btn btn-primary btn-lg" type="button">원문보기</button></a>
      </div>
    </div>
