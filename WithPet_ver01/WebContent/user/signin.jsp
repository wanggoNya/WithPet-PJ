							...
							<form action="useradddb.jsp" method="post"
								...
								<div class="row">
									<div class="col-md-6 mb-3">
										<label for="name">아이디</label> <input type="text" name="account"
								...
								<div class="mb-3">
									<label for="email">이메일</label> <input type="email"
										 name="email" class="form-control" id="email" placeholder="you@example.com"
										required>
								</div>
								...
								<div class="mb-3">
									<label for="phoneNumber">핸드폰 번호(11자리)</label> <input name="phoneNumber"
								...
								<div class="mb-3">
									<label for="birthday">생년월일 8자리</label> <input name="birthday" type="text"
										class="form-control" id="birthday" placeholder="YYYYMMDD"
										required>
								</div>
