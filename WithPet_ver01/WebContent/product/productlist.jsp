...
<div class="container" >
  <div class="p- p-md-5 mb-4 text-white rounded " style="background-color: peachpuff;">
          <img class="d-block mx-auto mb-4" src="/img/logo.png" alt="" width="300" height="250">
          <h2>상품목록</h2>
...
%>
  <div class="col mb-5">
      <div class="card h-100" >
          ...
          <!-- Product image-->
          <img class="card-img-top" name="img" src="/img/<%=product.getImage() %>" width='450' height='300' alt="상품 이미지" />
          <!-- Product details-->
